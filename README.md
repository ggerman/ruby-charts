...
| Feature | ruby-charts | TradingView |
|---------|------------|------------|
| API Cost | Free | $299+/month |
| Data Source | Local files | API |
| Offline | ✅ Yes | ❌ No |
...
| Feature | ruby-charts | Plotly/ChartJS |
|---------|------------|----------------|
| Language | Ruby only | Requires JS |
| Server-side | ✅ Yes | ❌ No |
| Email Friendly | ✅ PNG embed | ❌ Requires JS |
| Learning Curve | Low | Medium-High |
| Interactivity | Static | Interactive |

### vs ImageMagick

| Feature | ruby-charts | ImageMagick |
|---------|------------|------------|
| Purpose | Charts | General images |
| Data Format | CSV/XLSX/YAML | Pixels/files |
| Speed | 28x faster | Slow |
| API Quality | Simple | Complex |
...
- [ ] Real-time charts (GIF animation)
...
- [libgd](https://libgd.github.io/) - The legendary graphics library
- [FreeType](https://www.freetype.org/) - Font rendering
- Ruby community for 30 years of amazing tools
